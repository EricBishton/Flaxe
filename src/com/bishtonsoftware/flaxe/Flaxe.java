    ...
    public static void main(String[] args) throws IOException {
        ...
        if (argumentCount != 3) {
            ...
            usage.append("Usage: flaxe.jar <action> <as3-source-folder> <haxe-destination-folder>\n")
              .append("Where:\n")
              .append("- `<action>` is one of `rename`, `convert`:\n")
              .append("  + `rename` means to only rename `.as` file extensions to `.hx`\n")
              .append("  + `convert` means to rename file extensions, and convert file contents by replacing recognized patterns with Haxe replacements.\n")
